      ...
      <el-container>
        <el-header style="height: 12vh">
          <el-row :gutter="20">
            ...
            >
            <el-col :span="6"
              ><p>注册事件：{{ user.created_time }}</p></el-col
            >
          </el-row>
        </el-header>
        <el-main>
        ...
        <el-footer>
            <pagination :total="form.total" :page.sync="form.page" :limit.sync="form.limit" @pagination="getData" style="padding:0;padding-top:10px;margin:0" layout="total,prev,pager,next"></pagination>
        </el-footer>
      </el-container>
    </el-dialog>
  </div>
