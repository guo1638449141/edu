<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="音频内容" prop="content" width="500">
        <template slot-scope="{ row }">
      ...
      <el-table-column label="更新状态" prop="sub_count" align="center" width="100">
        <template slot-scope="{ row }">
            <span :style="row.isend === 1 ? '' :  'color:red'">{{ row.isend | filterSend }}</span>
        </template>
      </el-table-column>
      <el-table-column
        label="订阅量"
